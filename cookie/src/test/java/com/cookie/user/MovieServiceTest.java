...
class MovieServiceTest {
    ...
    void testGetMovieReviewList() {
        ...
        assertNotNull(response);
        assertEquals("Inception", response.getTitle());
        assertEquals("CHILD", response.getRating());
    ...
    void testGetLikedMoviesByUserId() {
        ...
        // When
        List<MovieResponse> responses = movieService.getLikedMoviesByUserId(userId);
    ...
    void testGetMoviesByCategoryId() {
        ...
        // When
        List<MovieResponse> responses = movieService.getMoviesByCategoryId(categoryId);
